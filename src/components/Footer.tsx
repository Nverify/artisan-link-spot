        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 sm:gap-10 mb-8 sm:mb-10">
            ...
            <div className="animate-fade-in-up stagger-2">
              <h3 className="font-bold mb-4 sm:mb-5 text-base sm:text-lg">
                For Customers
              </h3>
              <ul className="space-y-2 sm:space-y-3 text-xs sm:text-sm text-secondary-foreground/90">
                <li>
                  <a
                    href="#"
                    className="hover:text-primary transition-colors link-underline font-medium"
                  >
                    Find Artisans
                  </a>
                </li>
          ...
          <div className="border-t border-secondary-foreground/20 pt-8 sm:pt-10 flex flex-col md:flex-row justify-between items-center gap-4 sm:gap-6">
            ...
            <div className="flex items-center gap-4 sm:gap-5">
              <a
                href="https://www.facebook.com/FixRiteng"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full glass flex items-center justify-center hover:bg-primary hover:text-white transition-all hover-lift touch-manipulation"
              >
                <Facebook className="w-4 h-4 sm:w-5 sm:h-5" />
              </a>
              <a
                href="https://www.instagram.com/fixrite_ng/"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-full glass flex items-center justify-center hover:bg-primary hover:text-white transition-all hover-lift touch-manipulation"
              >
